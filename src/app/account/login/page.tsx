...
export default function AccountLoginPage() {
  ...
  return (
    <main className="flex flex-1 items-center justify-center bg-bg px-6 py-12">
      ...
      >
        <h1 className="font-display text-[19px] font-bold text-ink">Sign in</h1>
        <p className="mt-1 text-[13px] text-muted">Welcome back to Pure Motion.</p>
        ...
        <p className="mt-4 text-center text-[12.5px] text-muted">
          New to Pure Motion?{" "}
          <Link href="/account/signup" className="font-bold text-accent-strong hover:underline">
            Create an account
          </Link>
        </p>
      </form>
